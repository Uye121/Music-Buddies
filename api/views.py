...
class GetRoom(APIView):
    ...
    def get(self, request, format=None):
        ...
        return Response({'Bad Request': 'Parameter missing'}, status=status.HTTP_400_BAD_REQUEST)
    ...
    def patch(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            if room.host != user_id:
                return Response({'Error': 'User does not have permisison'}, status=status.HTTP_403_FORBIDDEN)
